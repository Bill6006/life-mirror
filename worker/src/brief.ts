...
async function writeFreeReview(env: JobEnv, store: Store, run: Runner, now: Date, day: string, sheet: FactSheet, trigger: Trigger, opts: BriefOptions, started: number, fallback?: string): Promise<BriefResult> {
