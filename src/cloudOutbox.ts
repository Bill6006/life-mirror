...
export const SYNCED_STORES: readonly string[] = ['checkins', 'settings', 'wins', 'privateItems', 'offers', 'cards', 'outcomes', 'days', 'studyNights', 'aims', 'skills', 'rungMarks', 'declarations', 'forecasts', 'forecastScores']
