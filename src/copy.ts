...
export const copy = {
  ...
  settings: {
    ...
    data: 'Data',
    dataNote: 'Your check-ins and settings are stored on this phone only. Nothing leaves it but the ping address, if you set one up.',
    phase: 'Phase 3 of the build plan: reliable reminders.',
  },
  private: {
    title: 'Private',
